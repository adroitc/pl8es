                ...
                :include => {
                  :dishes => {
                    ...
                    :methods => [
                      :image_url,
                      :dish_lang,
                      :dishsuggestion_1_present,
                      :dishsuggestion_2_present,
                      :dishingredients_present,
                      :dishingredients
                    ],
                    :include => {
                      :dishsuggestion_1 => {
        ...
        :content_style => JSON.parse(
          app_user.menuColor.to_json(
            :only => [
              ...
              :bev_background,
              :bev_background_selected,
              :bev_background_active,
              :bev_text,
              :bev_text_selected,
              :bev_text_active,
              ...
              :sub_background,
              :sub_background_selected,
              :sub_background_active, 
              :sub_text,
              :sub_text_selected,
              :sub_text_active
            ]
